...
class VisualProcessingPredictShapes extends StatefulWidget {
  final String? gameId;

  const VisualProcessingPredictShapes({super.key, required this.gameId});

  @override
  State<VisualProcessingPredictShapes> createState() =>
      _VisualProcessingPredictShapesState();
}

class _VisualProcessingPredictShapesState
    extends State<VisualProcessingPredictShapes> {
  int selection = -1;
  String level = "medium";
  String uId = '';
